...
(function() {
  ...
  window.Circle = (function(_super) {
    var callback_delete_circleknowledgecomment, form_cancel, form_submit, _args, _downedBlock, _selectingBlock, _timechartParent, _timechartPressing, _viewColor;
    ...
    function Circle(args) {
      ...
      $(function() {
        ...
        return Dajaxice.ck.ajax_get_circleknowledgecomments(function(data) {
          var $timechartViewData, comment, height, k, key, left, time, top, v, width, _results;
          _results = [];
          for (k in data) {
            v = data[k];
            if (v.length === 0) {
            ...
            _results.push((function() {
              ...
              for (key in v) {
                ...
                _results1.push($(".timechart-view-wrapper-" + k).append($timechartViewData));
              }
              return _results1;
            })());
          }
